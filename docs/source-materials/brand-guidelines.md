...
>
> Earthy -- Spiritual Modern -- Slight Tech

---

## Color System -- Rose Clay Mauve
...
| Property | Value |
|---|---|
| HEX | `#9C6F6E` (fluctuates between `#9A6B6A` and `#9E726F` depending on texture + light) |
| RGB | ~156, 111, 110 |
| HSL | warm, low saturation, mid-dark value |
...
It is not feminine -- it is biological and geological.

### Where It Belongs in the Brand System
...
|---|---|
| Aura White | `#F7F5F2` |
| Soft Charcoal | `#3F3E3C` |

#### Secondary

| Color | HEX |
|---|---|
| Rose Clay Mauve | `#9C6F6E` |
...
### Typography Rules on Rose Clay Mauve

On Rose Clay Mauve backgrounds:
...
The success of this color is because of texture.
...
| Property | Value |
|---|---|
| HEX | `#7A3A34` to `#7F3F39` (screen variance) |
| RGB | ~122--127, 58--63, 52--57 |
| Hue | ~6--10 degrees (red--earth) |
| Saturation | low--moderate |
| Lightness | low--mid |

**How it feels:**

- **Material:** fired clay, iron-rich earth, terracotta tile
- **Temperature:** warm, grounded, weighty
- **Energy:** solid, embodied, ancient rather than romantic

**Why it reads differently than mauve:**

- Much less violet
- More iron / oxide than rose
- Feels architectural and elemental
...
**Who This Is For:** Adults -- women and men -- especially:
...
**Audience Desire:** They want to move through complexity without losing themselves. They are ready to rise above noise. They are seeking alignment and peace.
...
## 7. Brand Messaging Pillars

| Pillar | Message |
|---|---|
| **Coherence** | When coherence returns, life aligns. |
...
- *"You are not the summit. You are the mountain."*
...
Minimal line rose icon only (no leaves, no botanical detail).
...
## 10. Color Palette (Neutral + Earth)

### Goal

Earthy, grounded, gender-neutral. Still warm, refined, and modern. Feels good for men + women + non-binary audiences.

### Neutralized Palette

| # | Color | HEX | Notes |
|---|---|---|---|
| 1 | Muted Clay Taupe | `#9A8F88` | Same warmth, more mineral, reads earthy |
| 2 | Balanced Stone | `#BFB3AA` | Cooler, architectural / unisex |
| 3 | Neutral Sand | `#E4DED8` | More linen / parchment feel |
| 4 | Aura White | `#F7F5F2` | Already excellent and neutral |
| 5 | Antique Olive Brass | `#9E956B` | More olive, masculine + feminine balance, grounded, premium, timeless |
...
|---|---|---|
| **Headlines** | Cormorant Garamond | Sacred elegance, timeless softness |
| **Body** | Inter | Modern clarity, slight tech precision |
