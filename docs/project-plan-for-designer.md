...
Each major deliverable has its own detailed designer plan. This master document provides the full platform vision; the individual plans provide the focused brief for each deliverable.

| # | Deliverable | Status | Designer Plan |
|---|-------------|--------|---------------|
...
| 3 | **Manuals** (redo / redesign) | Planned -- brief ready, image mapping + PDF page-by-page replacement guide included | [`project-plan-for-designer-manuals.md`](project-plan-for-designer-manuals.md) |
| 4 | **Platform sections** (invitation, forms, website pages) | Future | Covered in this document (Sections B-E below) |

**Current focus:** The MDR Teacher's Resource Manual is the first deliverable. The brand book follows. The manuals redesign (Level 2 and Level 3 2026) is **urgent -- classes start March 15, 2026**. All imagery is already on the site in the Teachers Training section -- the manuals plan now includes a complete image-to-manual mapping (Section 3.5) and a page-by-page PDF image replacement guide (Section 3.6) so the designer knows exactly which image to keep, replace, or add on each page. The Level 2 manual is now standalone (Level 1 content removed) and needs a new cover page. Updated PDFs go directly into `public/resources/manuals/` -- the teaching section already has download buttons pointing to these files. No code changes needed. Manuals available in four languages (English, Spanish, Portuguese, Greek). Platform sections come later. The design system and visual language established in the MDR will carry through everything that follows.
...
| Brand Book Content Plan | `docs/brand/roses-os-brand-book-content-plan.md` | What exists, what's drafted, what's missing for the brand book |
| MDR Source Plan | `docs/source-materials/plan-mdr.md` | Original MDR content plan and brand guidelines |
...
> **This section has its own detailed designer plan:** [`project-plan-for-designer-mdr.md`](project-plan-for-designer-mdr.md)
