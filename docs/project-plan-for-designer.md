...
**Access:** Protected by a static passcode: **4444**. This is intentionally a simple, shared, non-rotating code -- not a per-user login system. Teachers enter the passcode once to access this section. The passcode keeps the mDR out of public view while remaining easy for any authorized teacher to use.
...
- Teacher Visual Aid Manual PDF is protected by the static passcode (4444); all other PDFs are open
...
|---|---|---|
| Teacher Visual Aid Manual | Full manual export | Static passcode-protected (4444) |
...
| Teacher Visual Aid Manual | Web section design + PDF export design | Static passcode-protected (4444) for both web section and PDF export. Web section must work on tablet during live sessions |
