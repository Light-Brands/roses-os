...
| 3a | **Designer Action Steps** | Active -- concrete task checklist for all manual & website image changes | [`project-plan-for-designer-action-steps.md`](project-plan-for-designer-action-steps.md) |
