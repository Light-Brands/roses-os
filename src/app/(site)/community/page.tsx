...
export const metadata: Metadata = {
  title: 'Community',
  description:
    'Join the International Aura and Dream School community — free weekly gatherings, Rose Meditation guidances, practitioner meetings, and continued programs like Aura for Life and Teachers Training.',
  keywords: [
  ...
  openGraph: {
    title: 'Community | International Aura and Dream School',
    description:
