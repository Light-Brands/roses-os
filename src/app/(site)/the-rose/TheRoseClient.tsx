    ...
    <>
      ...
      >
        <p>
          ...
          culture and era, it has represented the same truth — the opening of the soul.
          Its unfolding petals mirror the stages of inner development: from bud to full
          bloom, from potential to realization. No other symbol carries this depth across
