...
const theRoseFAQs = [
  ...
  },
  {
    ...
    answer:
      'The rose is the oldest spiritual symbol in the known universe. Across every major tradition — from Rumi\'s Sufi poetry where it represents divine love, to Christianity\'s Mystic Rose, to the Rosicrucian tradition where its unfolding petals symbolize awakening consciousness — the rose has pointed to the same truth: the opening of the soul. Salvador Dalí\'s painting The Meditative Rose (1958) carries this symbolism into modern art, depicting a transcendent rose floating above the earthly plane. In ROSES OS, the rose is the living instrument at the center of the meditation practice.',
  },
  {
    question: 'Why is the rose used in meditation?',
    answer:
      'The rose is used in meditation because its unfolding petals mirror the stages of spiritual development — from potential to realization. Sacred across Sufism, Christianity, Hinduism, and the ancient mystery schools, the rose serves as a universal tool for cleansing the energy field, restoring coherence, and accessing deeper states of awareness. Salvador Dalí\'s The Meditative Rose (1958) captures this quality, showing the rose as a gateway to contemplation and transcendence. In Rose Meditation, it becomes the central instrument for reading and transforming consciousness.',
  },
];
