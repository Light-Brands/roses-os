...
export async function GET() {
  try {
    ...
    doc.setTitle('International Aura and Dream School - Programs Guide');
    ...
    // =========================================================================
    {
      ...
      y = drawWrappedText(page,
        'International Aura and Dream School is a living consciousness ecosystem rooted in more than three decades of lineage. It offers a path of remembrance through Rose Meditation and Aura Reading \u2014 two powerful technologies that cleanse, protect, and awaken the energy field, restoring you to your original coherence.',
      ...
      const lineageData = [
        ...
        { year: '2026', name: 'International Aura and Dream School', desc: 'Crystallizes decades of lineage into a global ecosystem.' },
      ];
    ...
    // =========================================================================
    {
      ...
      y = drawWrappedText(page,
        'Beyond the courses, International Aura and Dream School offers a vibrant community of practice. Free weekly gatherings, guided meditations, and monthly meetings sustain your journey and deepen your connection with fellow practitioners around the world.',
