    ...
    <>
      ...
      >
        <nav className="container-premium">
          <div className="relative flex items-center min-h-[56px] h-auto py-2 sm:h-16 lg:h-[72px] w-full">
            ...
            <div className="z-10 flex-1 min-w-0 max-w-[55%] sm:max-w-[60%] md:max-w-none lg:flex-initial lg:flex-shrink-0 lg:absolute lg:left-1/2 lg:top-1/2 lg:-translate-x-1/2 lg:-translate-y-1/2 lg:max-w-[300px] xl:max-w-none">
              {logo || <Logo size="lg" />}
            </div>
