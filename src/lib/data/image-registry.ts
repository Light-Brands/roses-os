...
const manualOnlyImages: ImageEntry[] = [
  ...
  { id: 'l3-analyzer-sacred-space', label: 'Sacred Space Analyzer', canonicalPath: '/public/rose med images/level-3/40-sacred-space-analyzer.jpeg', scope: 'shared', manualLevels: [3], manualFilename: '40-sacred-space-analyzer.jpeg' },
