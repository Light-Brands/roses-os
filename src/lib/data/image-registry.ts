...
const manualOnlyImages: ImageEntry[] = [
  ...
  { id: 'l3-analyzer-sacred-space', label: 'The Analyzer & Sacred Space', canonicalPath: '/public/rose med images/level-3/40-analyzer-and-sacred-space.jpeg', scope: 'shared', manualLevels: [3], manualFilename: '40-analyzer-and-sacred-space.jpeg' },
