...
export const openingHistory = {
  ...
  lineage: 'Berkeley Psychic Institute → Anastasia Plunk → Angelina Ataide → Escola da Aura → International Aura and Dream School',
};
...
export const level3Slides: TeachingSlide[] = [
  {
    ...
    reimaginedImage: 'level-3/39-analyzer.jpeg',
    level: 3,
    section: 'advanced',
  },
  {
    ...
    reimaginedImage: 'level-3/40-sacred-space-analyzer.jpeg',
    level: 3,
    section: 'advanced',
  },
  {
