...
export const lineageEntries: LineageEntry[] = [
  ...
  { id: '3', year: '1990s', name: 'Angelina Ataide', description: 'Founder of CELARIS, formerly Escola da Aura & Sueños. For over thirty years, she has upheld the Rose as a living transmission, initiating more than six thousand individuals into the Rose tradition.' },
  { id: '4', year: '2025', name: 'ROSES OS', description: 'The platform crystallizes decades of lineage wisdom into an accessible ecosystem for consciousness, remembrance, and coherent living.' },
];
