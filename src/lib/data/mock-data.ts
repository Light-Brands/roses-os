...
export const pathLevels: PathLevel[] = [
  ...
  },
  {
    ...
    description: 'Perception sharpens and refines. Reading becomes more precise and confident as clairvoyance, clairsentience, and clairaudience develop with practice and community.',
    focus: ['Refined clairvoyance', 'Advanced reading techniques', 'Energetic precision', 'Deepened perception'],
  },
  {
    id: '6',
    level: 6,
    title: 'Aura 3',
    subtitle: 'Healing & Navigation',
    description: 'Aura reading becomes a vehicle for deeper healing. Navigate complex energetic landscapes and support transformation in yourself and others with increasing clarity.',
    focus: ['Advanced healing work', 'Complex energy navigation', 'Integration facilitation', 'Expanded intuitive capacity'],
  },
  {
    id: '7',
    level: 7,
