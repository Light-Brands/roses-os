  ...
  sections: [
    {
      ...
      images: [
        ...
        { concept: 'Protection of the Space', slideNumber: 20, reimaginedImage: 'level-2/20-create-the-room.jpeg' },
        { concept: 'Cleansing of the Space', slideNumber: 21, reimaginedImage: 'level-2/21-cleanse-the-space.jpeg' },
        { concept: 'Owning Your Space', slideNumber: 22, reimaginedImage: 'level-2/22-owning-space.jpeg', originalImage: 'level-2/22-protect-the-space-original.PNG' },
      ],
    },
    {
      title: 'Chakra System',
    ...
    },
    {
      ...
      images: [
        ...
        { concept: 'Golden Sticky Roses — Phase 4', slideNumber: 38, reimaginedImage: 'level-2/38-golden-sticky-4.jpeg' },
      ],
    },
  ],
};
  ...
  sections: [
    {
      ...
      images: [
        ...
        { concept: 'Expansion of Grounding Cord', slideNumber: 6, reimaginedImage: 'level-1/06-expansion-grounding-cord.png' },
        { concept: 'Golden Sun Fills', slideNumber: 7, reimaginedImage: 'level-1/7-fillgoldensun.png' },
  ...
  sections: [
    {
      title: 'The Analyzer',
      images: [
        { concept: 'The Analyzer', slideNumber: 39, reimaginedImage: 'level-3/39-analyzer.jpeg' },
        { concept: 'Sacred Space Analyzer', slideNumber: 40, reimaginedImage: 'level-3/40-sacred-space-analyzer.jpeg' },
      ],
    },
    {
    ...
    },
    {
      ...
      images: [
        { concept: 'Cutting Cords', slideNumber: 42, reimaginedImage: 'level-3/42-cutting-cords.png' },
