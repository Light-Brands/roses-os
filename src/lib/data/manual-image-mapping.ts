  ...
  sections: [
    ...
    },
    {
      ...
      images: [
        ...
        { concept: 'Energy Recovery (Level 2)', slideNumber: 34, reimaginedImage: 'level-2/34-energy-recovery.jpeg' },
      ],
    },
    {
  ...
  sections: [
    {
      ...
      images: [
        ...
        { concept: 'Meditation Posture', slideNumber: 2, reimaginedImage: 'level-1/2-meditation-posture.PNG' },
        { concept: 'Grounding Cord', slideNumber: 3, reimaginedImage: 'level-1/3-grounding-cord.jpeg' },
        { concept: 'Golden Sun', slideNumber: 4, reimaginedImage: 'level-1/4-golden-sun.png' },
        { concept: 'Limits of Aura', slideNumber: 5, reimaginedImage: 'level-1/5-aura-exercise.PNG' },
        { concept: 'Expansion of Grounding Cord', slideNumber: 6, reimaginedImage: 'level-1/6-expansion-grounding-cord.jpeg' },
        { concept: 'Golden Sun Fills', slideNumber: 7, reimaginedImage: 'level-1/7-golden-sun-fills.png' },
        { concept: 'Earth Energy', slideNumber: 8, reimaginedImage: 'level-1/8-earth-energy.PNG' },
        { concept: 'Cosmos Circuit', slideNumber: 9, reimaginedImage: 'level-1/9-cosmos-circuit.jpeg' },
