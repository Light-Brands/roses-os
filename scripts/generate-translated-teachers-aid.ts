...
const EN_SLIDES: Record<string, { concept: string; teachingText: string }> = {
  ...
  'l2-energy-recovery': { concept: 'Energy Recovery of Each Chakra (Level 2)', teachingText: 'After cleansing, the energy recovery process is repeated at a deeper level.' },
  'l2-golden-sticky-1': { concept: 'Golden Sticky Roses — Phase 1 (Chakra Placement)', teachingText: 'Golden sticky roses are placed on each of the seven chakras.' },
  'l2-golden-sticky-2': { concept: 'Golden Sticky Roses — Phase 2 (Body Placement)', teachingText: 'Golden sticky roses are placed at the joints and extremities of the body.' },
  'l2-golden-sticky-3': { concept: 'Golden Sticky Roses — Phase 3 (Full Body Coverage)', teachingText: 'Golden sticky roses are placed throughout the entire body.' },
  'l2-golden-sticky-4': { concept: 'Golden Sticky Roses — Phase 4 (Integration)', teachingText: 'After the golden sticky roses have done their work, a large Golden Rose appears above the head.' },
